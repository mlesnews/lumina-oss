...
export function activate(context: vscode.ExtensionContext) {
    ...
    const statusBarItem = vscode.window.createStatusBarItem(
        ...
        900 // Priority - appears before other items
    );
    ...
    // Set up file watcher
    const queueStateWatcher = vscode.workspace.createFileSystemWatcher(
        new vscode.RelativePattern(workspaceRoot, 'data/unified_queue/queue_state.json')
    );
